...
* SDK Folder
	...
	* lib
		* sdk-core-java-1.1.7.jar `SDK Core`
		* sdk-core-java-1.1.7-sources.jar		`SDK Core's source code`
	* Readme.md	`Readme.md`
	* LICENSE ` License`
...
#3. Advance use case
`sdk-core-java-1.1.7` use ApacheHttpClient_4.5.2 as the client to support advance use case.
